...
export interface ConfigTypo {
    ...
    APP_IMS_SERVICE_URL: string,
    APP_KMS_SERVICE_URL: string,
    APP_INVS_SERVICE_URL: string,
    ...
    APP_MMS_ASSETS_SERVICE_URL:string,

}
export const configVariables: ConfigTypo = {
    APP_UMS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_UMS_SERVICE_URL'] : process.env['APP_UMS_SERVICE_URL'] || 'https://xpparel-qa-ums.schemaxtech.in',
    APP_WMS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_WMS_SERVICE_URL'] : process.env['APP_WMS_SERVICE_URL'] || 'https://xpparel-qa-wms.schemaxtech.in',
    APP_OMS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_OMS_SERVICE_URL'] : process.env['APP_OMS_SERVICE_URL'] || 'https://xpparel-qa-oms.schemaxtech.in',
    APP_OES_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_OES_SERVICE_URL'] : process.env['APP_OES_SERVICE_URL'] || 'https://xpparel-qa-oes.schemaxtech.in',
    APP_CPS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_CPS_SERVICE_URL'] : process.env['APP_CPS_SERVICE_URL'] || 'https://xpparel-qa-cps.schemaxtech.in',
    APP_IMS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_IMS_SERVICE_URL'] : process.env['APP_IMS_SERVICE_URL'] || 'https://xpparel-qa-ims.schemaxtech.in',
    ...
    APP_ETS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_ETS_SERVICE_URL'] : process.env['APP_ETS_SERVICE_URL'] || 'https://xpparel-qa-ets.schemaxtech.in',
    APP_DMS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_DMS_SERVICE_URL'] : process.env['APP_DMS_SERVICE_URL'] || 'https://xpparel-qa-dms.schemaxtech.in',
    APP_SPS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_SPS_SERVICE_URL'] : process.env['APP_SPS_SERVICE_URL'] || 'https://xpparel-qa-sps.schemaxtech.in',
    APP_PTS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_PTS_SERVICE_URL'] : process.env['APP_PTS_SERVICE_URL'] || 'https://xpparel-qa-pts.schemaxtech.in',
    APP_QMS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_QMS_SERVICE_URL'] : process.env['APP_QMS_SERVICE_URL'] || 'https://xpparel-qa-qms.schemaxtech.in',
    APP_PKMS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_PKMS_SERVICE_URL'] : process.env['APP_PKMS_SERVICE_URL'] || 'https://xpparel-qa-pkms.schemaxtech.in',    
    APP_PKDMS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_PKDMS_SERVICE_URL'] : process.env['APP_PKDMS_SERVICE_URL'] || 'https://xpparel-qa-pkdms.schemaxtech.in',
    APP_KMS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_KMS_SERVICE_URL'] : process.env['APP_KMS_SERVICE_URL'] || 'https://xpparel-qa-kms.schemaxtech.in',
    APP_INVS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_INVS_SERVICE_URL'] : process.env['APP_INVS_SERVICE_URL'] || 'https://xpparel-qa-invs.schemaxtech.in',
    ...
    APP_MMS_ASSETS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_MMS_ASSETS_SERVICE_URL'] : process.env['APP_MMS_ASSETS_SERVICE_URL'] || 'https://mms-assets-be.schemaxtech.in/api',

...
export const configVariables: ConfigTypo = {
    APP_DMS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_DMS_SERVICE_URL'] : process.env['APP_DMS_SERVICE_URL'] || 'http://143.198.233.137:9010',
    APP_WMS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_WMS_SERVICE_URL'] : process.env['APP_WMS_SERVICE_URL'] || 'http://143.198.233.137:9005',
    APP_OMS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_OMS_SERVICE_URL'] : process.env['APP_OMS_SERVICE_URL'] || 'http://143.198.233.137:9006',
    APP_OES_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_OES_SERVICE_URL'] : process.env['APP_OES_SERVICE_URL'] || 'http://143.198.233.137:9007',
    APP_CPS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_CPS_SERVICE_URL'] : process.env['APP_CPS_SERVICE_URL'] || 'http://143.198.233.137:9008',
    APP_UMS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_UMS_SERVICE_URL'] : process.env['APP_UMS_SERVICE_URL'] || 'http://143.198.233.137:9004',
    APP_ETS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_ETS_SERVICE_URL'] : process.env['APP_ETS_SERVICE_URL'] || 'http://143.198.233.137:9009',
    APP_IAM_SERVER_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_IAM_SERVER_URL'] : process.env['APP_IAM_SERVER_URL'] || 'http://143.198.233.137:9005',
    APP_IAM_CLIENT_ID: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_IAM_CLIENT_ID'] : process.env['APP_IAM_CLIENT_ID'] || 'http://143.198.233.137:9005',

...
export const configVariables: ConfigTypo = {
    ...
    APP_IMS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_IMS_SERVICE_URL'] : process.env['APP_IMS_SERVICE_URL'] || 'https://xpparel-dev-ims.schemaxtech.in',
    ...
    APP_PKMS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_PKMS_SERVICE_URL'] : process.env['APP_PKMS_SERVICE_URL'] || 'https://xpparel-dev-pkms.schemaxtech.in',    
    ...
    APP_INVS_SERVICE_URL: (typeof window !== 'undefined') ? window[`_env_`]?.['APP_INVS_SERVICE_URL'] : process.env['APP_INVS_SERVICE_URL'] || 'https://xpparel-dev-invs.schemaxtech.in',

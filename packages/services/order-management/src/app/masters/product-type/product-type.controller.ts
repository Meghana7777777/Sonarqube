...
import { CommonRequestAttrs, GlobalResponseObject, ProductTypeIdRequest, ProductTypeRequest, ProductTypeResponse } from '@xpparel/shared-models';
...
export class ProductTypeController {
 ...
 @Post('getProductDetailsByProductType')
  async getProductDetailsByProductType(@Body() req: ProductTypeIdRequest): Promise<ProductTypeResponse> {
    try {
      return await this.service.getProductDetailsByProductType(req);
    } catch (error) {
      return returnException(ProductTypeResponse, error)
    }
  }

...
import { PackFGGenProcessor } from './processors/pack-fg-gen.processor';
import { PackJobGenProcessor } from './processors/pack-jobs-gen.processor';
import { PKMS_OSL_DEL_Processor } from './processors/packing-osl-del.processor';
import { PKMS_OSL_GEN_Processor } from './processors/packing-osl-gen.processor';

@Module({
  imports: [
    ...BullQueueRegister,
    forwardRef(() => PreIntegrationModule),
    forwardRef(() => PackingListModule),
  ],

  providers: [
    BullQueueService, RedisHelperService, BullArenaUIProvider, PackJobGenProcessor,PackFGGenProcessor,
    PKMS_OSL_DEL_Processor, PKMS_OSL_GEN_Processor,
    {
      provide: 'arenaQueues',

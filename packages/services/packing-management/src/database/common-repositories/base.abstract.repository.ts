...
export abstract class BaseAbstractRepository<T extends HasId>
	...
	public async increment(conditions: FindOptionsWhere<T>, propertyPath: string, value: string | number): Promise<UpdateResult> {
		return await this.entity.increment(conditions, propertyPath, value)
	}

	public async insert(data: QueryDeepPartialEntity<T> | QueryDeepPartialEntity<T>[]): Promise<InsertResult> {

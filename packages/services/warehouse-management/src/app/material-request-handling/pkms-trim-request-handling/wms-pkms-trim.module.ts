...
import { WmsPKMSTrimRequestController } from "./wms-pkms-trim.controller";
import { WmsPKMSTrimRequestService } from "./wms-pkms-trim.service";
import { KnittingJobMaterialAllocationService, PackMaterialReqServices } from "@xpparel/shared-services";
...
@Module({
  ...
  controllers: [WmsPKMSTrimRequestController],
  providers: [WmsPKMSTrimRequestService,
    PackMaterialReqServices,
  ...
  exports: [
    WmsPKMSTrimRequestService
  ]
})
export class WmsPKMSTrimRequestModule { }
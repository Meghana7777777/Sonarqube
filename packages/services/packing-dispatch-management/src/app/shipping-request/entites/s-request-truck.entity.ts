...
import { PkTruckTypeEnum } from "@xpparel/shared-models";
...
export class SRequestTruckEntity extends AbstractEntity {
    ...
    @Column("tinyint", { name: "loading_status", nullable: false, comment: 'Loading status. 0 - OPEN, 1 - Loading started, 2 - Loading completed', default: 0 })

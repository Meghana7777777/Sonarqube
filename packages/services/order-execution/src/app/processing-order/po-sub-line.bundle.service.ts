...
import { BundleGenStatusEnum, GlobalResponseObject, MC_BundleCountModel, MC_MoNumberRequest, MC_MoProcessTypeModel, MC_PoPslbBundleDetailModel, MC_ProductSubLineBundleCountDetail, MOC_BundleDetail, MoProductSubLineIdAndQtyRequest, MoProductSubLineIdsRequest, PO_PoSerialRequest, ProcessTypeEnum, ProductSubLineAndBundleDetailModel, ProductSubLineAndBundleDetailResponse } from "@xpparel/shared-models";
import { MOConfigService } from "@xpparel/shared-services";
import { DataSource } from "typeorm";
import { GenericTransactionManager } from "../../database/typeorm-transactions";
import { CutOrderProductBundleStateEnum, PoSubLineBundleEntity } from "../common/entities/po-sub-line-bundle.entity";
    ...
    */
    async createBundlesForPo(reqObj: PO_PoSerialRequest): Promise<GlobalResponseObject> {
        ...
        try {
            ...
            for (const eachProcessType of routingGroupDetails) {
                for (const eachMoSubLine of moSubLineInfoWithMoNumber) {
                    ...
                    for (const eachBundle of moSubLineBundles) {
                        ...
                        poBundlesObj.bundleState = CutOrderProductBundleStateEnum.OPEN;
            ...
            // now call the CPS bundling service to create these bundles over there
            this.poHelperService.createPslBundlesInCPS(processingSerial, companyCode, unitCode, username);

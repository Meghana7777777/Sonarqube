...
@Entity('po_actual_docket_bundle')
export class PoActualDocketBundleEntity extends AbstractEntity {
    ...
    @Column("varchar", { length: 100, name: "style", nullable: true, comment: '' })
    style: string;

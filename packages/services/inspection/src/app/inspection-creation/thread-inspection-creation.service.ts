...
import { GlobalResponseObject, InsBatchNosRequest, InsFabInsSelectedBatchModelAttrs, InsFabInsSelectedBatchResponse, InsFabricInspectionRequestCategoryEnum, InsInspectionActivityStatusEnum, InsInspectionFinalInSpectionStatusEnum, InsInspectionHeaderAttributes, InsInspectionItemEnum, InsInspectionLevelEnum, InsInspectionMaterialEnum, InsInspectionMaterialTypeEnum, InsIrActivityChangeRequest, InsTypesEnum, InsUomEnum, PackFabricInspectionRequestCategoryEnum, ThreadInsCreateExtRefRequest, ThreadInsSelectedBatchResponse } from "@xpparel/shared-models";
...
@Injectable()
export class ThreadInspectionCreationService {
    constructor(
    ...
    async createThreadInspectionRequest(req: ThreadInsCreateExtRefRequest): Promise<GlobalResponseObject> {
        const manager = new GenericTransactionManager(this.dataSource);
        console.log("ThreadInsCreateExtRefRequest43234", req);
        try {
            ...
            for (const batch of insItemsRes.data) {
                ...
                inspHeaderEntityObj.insMaterialType = InsInspectionMaterialTypeEnum.THREAD;
                inspHeaderEntityObj.insMaterial = InsInspectionMaterialEnum.SPOOL;
                inspHeaderEntityObj.insType = InsTypesEnum.THREADINS;
                ...
                for (const lot of batch.lotInfo) {
                    ...
                    insRequestLine.insMaterial = InsInspectionMaterialEnum.SPOOL;
                    insRequestLine.insMaterialType = InsInspectionMaterialTypeEnum.THREAD;
                    insRequestLine.insType = InsTypesEnum.THREADINS;
            ...
            history.insType = InsTypesEnum.THREADINS;
    ...
    async deleteThreadInspectionRequest(req: InsBatchNosRequest): Promise<GlobalResponseObject> {
    ...
    async updateThreadInspectionActivityStatus(req: InsIrActivityChangeRequest): Promise<GlobalResponseObject> {
        ...
        try {
            ...
            Object.assign(history, {
                ...
                inspectionAreaI1: '',
                inspectionAreaI2: '',
                insType: InsTypesEnum.THREADINS,
                remarks: req.remarks,
            });

...
@Injectable()
export class YarnInspectionCreationService {
    constructor(
    ...
    async createYarnInspectionRequest(req: YarnInsCreateExtRefRequest): Promise<GlobalResponseObject> {
        const manager = new GenericTransactionManager(this.dataSource);
        try {
            console.log("YarnInsCreateExtRefRequest345", req);
            ...
            for (const batch of insItemsRes.data) {
                ...
                inspHeaderEntityObj.insMaterialType = InsInspectionMaterialTypeEnum.YARN;
                inspHeaderEntityObj.insMaterial = InsInspectionMaterialEnum.CONES;
                inspHeaderEntityObj.insType = InsTypesEnum.YARNINS;
                ...
                for (const lot of batch.lotInfo) {
                    ...
                    insRequestLine.insMaterial = InsInspectionMaterialEnum.CONES;
                    insRequestLine.insMaterialType = InsInspectionMaterialTypeEnum.YARN;
                    insRequestLine.insType = InsTypesEnum.YARNINS;
            ...
            history.insType = InsTypesEnum.YARNINS;
    ...
    async deleteYarnInspectionRequest(req: InsBatchNosRequest): Promise<GlobalResponseObject> {
    ...
    async updateYarnInspectionActivityStatus(req: InsIrActivityChangeRequest): Promise<GlobalResponseObject> {

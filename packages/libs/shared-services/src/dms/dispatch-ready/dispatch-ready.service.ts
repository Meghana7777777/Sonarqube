...
import { PkDSetBarcodesResponse, PkDSetCreateRequest, PkDSetGetBarcodesRequest, PkDSetIdsRequest, PkDSetItemBarcodesResponse, PkDSetItemIdsRequest, PkDSetResponse, PkDSetSubItemContainerMappingRequest, GlobalResponseObject, PackListIdRequest, PkDSetSubItemRefResponse } from '@xpparel/shared-models';
import { DMSCommonAxiosService } from '../common-axios.service';


export class DispatchReadyService extends DMSCommonAxiosService {

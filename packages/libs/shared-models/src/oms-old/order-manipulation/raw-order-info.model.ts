// import { PackMethodEnum, MoProductStatusEnum } from "../enum";
...
//     salOrdNo: string;
//     purOrdNo: string;
//     prodType: string; // the prod type shirt/tshirt
...
//     buyerName: string;
//     packMethod: PackMethodEnum; // this should be ENUM (1Pack, 2 Pack et..)
//     garmentVendor: string;
//     manufacturer: string;
//     packMethodConfirmed: boolean // TRUE: If the pack methods are defined and are confirmed by the user and we created the duplicate lines

...
export const manufacturingOrderDumpTableColumnToExcelColumnMap = new Map([
    ...
    ['Schedule', 'schedule'],
    ['Planned Cut Date', 'planCutDate'],
    ['Planned Prod Date', 'planProdDate'],
    ['zFeature', 'zFeature'],
    ['Size', 'size'],
    ['Quantity', 'quantity'],
...
export const manufacturingOrderDumpExcelUploadValidatorMap: Map<string, ExcelUploadValidator> = new Map([
    ...
    ['planCutDate', { type: 'string', strictTypeCheck: true, maxLength: 25, required: false, label: 'Planned Cut Date', isTrimPrefix: false }],
    ['planProdDate', { type: 'string', strictTypeCheck: true, maxLength: 25, required: false, label: 'Planned Prod Date', isTrimPrefix: false }],
    ...
    ['itemType', { type: 'string', strictTypeCheck: true, maxLength: 15, required: false, label: 'Item Type', isTrimPrefix: false }],
    ['itemCode', { type: 'string', strictTypeCheck: true, maxLength: 15, required: false, label: 'Item Code', isTrimPrefix: false }],
    ['itemColor', { type: 'string', strictTypeCheck: true, maxLength: 15, required: false, label: 'Item Color', isTrimPrefix: false }],
    ['itemUom', { type: 'string', strictTypeCheck: true, maxLength: 15, required: false, label: 'Item UOM', isTrimPrefix: false }],
    ['itemDesc', { type: 'string', strictTypeCheck: true, maxLength: 15, required: false, label: 'Item Desc', isTrimPrefix: false }],

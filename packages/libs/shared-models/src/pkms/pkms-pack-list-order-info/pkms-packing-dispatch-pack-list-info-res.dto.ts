...
import { PKMSPackingDispatchPackJobsInfoModel } from "../pkms-pack-order-info";
import { PKMSPackListAttrsModel } from "./pkms-pack-list-attribute-dto";

export class PKMSPackingDispatchPackListInfoModel {
    packJobs: PKMSPackingDispatchPackJobsInfoModel[]; // should get only send if iNeedPackJobs is true
    moId: number;
    packListId: number;
    packOrderId: number;
    packListDesc: string;
    ...
    constructor(
        packJobs: PKMSPackingDispatchPackJobsInfoModel[],
        moId: number,
        packListId: number,
        packOrderId: number,
        packListDesc: string,

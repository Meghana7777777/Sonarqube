...
//     /**
//      * 
//      * @param uniqueIdentifier company+unit+spo_number+manufacturing_order_item_code
//      * @param itemCode 
//      * @param itemName 
//      * @param itemDesc 
//      * @param quantity 
...
//      * @param poNumber 
//      * @param poItemLine 
//      * @param manufacturingOrderItemId 
//      * @param itemCategory 
//      * @param itemType 
//      * @param itemWeight 
//      * @param packHeaderId 
...
//         this.manufacturingOrderItemId = manufacturingOrderItemId;

export const moDumpTableColumnToExcelColumnMap = new Map([
    ['Mo', 'manufacturingOrderCode'],
    ['Mo Item', 'manufacturingOrderItemCode'],
    ['Customer Code', 'customerCode'],
    ['Customer Name', 'customerName'],
    ['Comp Code', 'companyCode'],
    ['Company Code', 'companyName'],
    ['Business Head', 'unitCode'],
    ...
    ['GMT PO Qty', 'manufacturingOrderItemQty'],
    ['PO Qty', 'quantity'],
    ['Unit Of Measure', 'uom'],
    ['Mo Creation Date', 'spoCreatedDate'],
    ['Mo Closed Date', 'spoDeliveryDate'],
...
export const moDumpExcelUploadValidatorMap: Map<string, ExcelUploadValidator> = new Map([
    ['manufacturingOrderCode', { type: 'string', strictTypeCheck: true, maxLength: 15, required: true, label: 'Mo', isTrimPrefix: true }],
    ['manufacturingOrderItemCode', { type: 'string', strictTypeCheck: true, maxLength: 15, required: true, label: 'Mo Item', isTrimPrefix: true }],
    ...
    ['unitCode', { type: 'string', strictTypeCheck: true, maxLength: 15, required: true, label: 'Business Head', isTrimPrefix: false }],
    ...
    ['manufacturingOrderItemQty', { type: 'number', strictTypeCheck: true, maxLength: 15, required: true, label: 'GMT PO Qty', isTrimPrefix: false }],
    ['quantity', {

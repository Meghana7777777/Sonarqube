...
// import { CommonRequestAttrs, ModuleTypeEnum, OpFormEnum, OpVRawMaterial, PoProdutNameRequest, ProcessTypeEnum, RawMaterialIdRequest, SewVerIdRequest, SewVersionModel, SewVersionRequest, UomEnum, VendorCategoryEnum, VendorCategoryRequest, WarehouseIdRequest, ProcessTypeEnumDisplayValues } from "@xpparel/shared-models";
import { CommonRequestAttrs, ProcessTypeEnum, OpFormEnum, OpVRawMaterial, PoProdutNameRequest, RawMaterialIdRequest, SewVerIdRequest, SewVersionModel, SewVersionRequest, InsUomEnum, VendorCategoryEnum, VendorCategoryRequest, WarehouseIdRequest, processTypeEnumDisplayValues } from "@xpparel/shared-models";
...
import { useAppSelector } from './../../../../../../ui/src/common';
const { Option } = Select
...
const OperationMappingGrid = (props: IProps) => {
    ...
    const [selectedJobtype, setSelectedJobtype] = useState<VendorCategoryEnum>();
    ...
    useEffect(() => {
        console.log(opGroupsData, "Trims required")
    }, [opGroupsData])
                ...
                <>{isOpSeqExists ? (<div>{value ? value : '-'}</div>) :
                    (
                        <Select
                            ...
                            value={value}
                            style={{ width: 130 }}
                            onChange={(val) => handleJobTypeChange(val, index)}
                        >
    ...
    const handleJobTypeChange = async (value, index) => {
        try {

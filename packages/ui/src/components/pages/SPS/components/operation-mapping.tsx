...
import { OrderLinesRequest, PoProdNameModel, PoSummaryModel, SewSerialRequest, SewVersionCloneRequest } from "@xpparel/shared-models";
import { POService, SewingMappingService } from "@xpparel/shared-services";
import { Button, Card, Checkbox, Col, Collapse, Flex, Modal, Tag, Tooltip } from "antd";
import { useAppSelector } from "packages/ui/src/common";
import { useEffect, useState } from "react";
import { AlertMessages } from "../../../common";
import OperationMappingGrid from "./operation-mapping/operation-mapping-grid-1";
...
const OperationMappingPage = (props: IProps) => {
    ...
    const getPoProductNames = (poSerial: number) => {
        sewVersionService.getPoProductNamesAndVersionInfo(props.poObj)
            .then((res) => {
                if (res.status) {
    ...
    const renderProducts = (item) => {
        ...
        return (
            <OperationMappingGrid {...propItems} />
        )
...
export default OperationMappingPage;
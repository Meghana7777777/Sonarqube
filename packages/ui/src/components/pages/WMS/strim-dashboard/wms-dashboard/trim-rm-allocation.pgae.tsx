...
const WMSRMAllocationsTablePage: React.FC<Props> = ({ processType, refreshKey, requestDeatils, jobNumber }) => {
  ...
  return (
    <Card size='small' title={<span style={{ display: 'flex', justifyContent: 'center' }} >RM Allocation Details</span>} bordered>
      <Table
        columns={columns}
        ...
        locale={{ emptyText: 'No Rm allocations found' }}
        bordered={true}
      />
      <Modal
...
export default WMSRMAllocationsTablePage;

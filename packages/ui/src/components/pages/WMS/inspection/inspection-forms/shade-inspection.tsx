...
export const ShadeSaggregationInspection = () => {
    const shadeSaggregationId = 'shadeSaggregationId';

    const generateAndDownloadPDF = async () => {
        const element = document.getElementById(shadeSaggregationId);
        ...
        pdf.save('Shade saggregation inspection.pdf');
    };
    return (
        <div>
            <ScxCard
            ...
            >
                <div id="shadeSaggregationId">
                    <Descriptions bordered title="Shade Saggregation inspection">
                    ...
                    <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                        ...
                        <ScxCard title="Shade level abstract"
                            style={{ width: '300px' }}
                        >
                            <table style={{ borderCollapse: 'collapse', width: '100%' }} >
                                <tr>
                                    <th className='tble'>Shade</th>
                                    <th className='tble'>No Of rolls</th>
                                    <th className='tble'>Qyantity</th>
                                </tr>
                            </table>
                        </ScxCard>
                    </div>

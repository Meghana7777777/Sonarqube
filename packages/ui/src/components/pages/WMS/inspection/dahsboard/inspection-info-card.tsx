import { InsFabricInspectionRequestCategoryEnum, InsInspectionActivityStatusEnum, InsInspectionBasicInfoModel, InsInspectionFinalInSpectionStatusEnum } from "@xpparel/shared-models";
...
interface InspectionInfoCardProps {
    inspectionRollsInfo: InsInspectionBasicInfoModel;
...
export const InspectionInfoCard = (props: InspectionInfoCardProps) => {
    ...
    function renderIrCardButtons(req: InsInspectionBasicInfoModel, insType: InsFabricInspectionRequestCategoryEnum, insProgress: InsInspectionActivityStatusEnum) {
    ...
    function renderCardTitle(reqInfo: InsInspectionBasicInfoModel) {
    ...
    function renderCardDescription(reqInfo: InsInspectionBasicInfoModel) {
        return <>
    ...
    function renderHoverContent(rollsInfo: InsInspectionBasicInfoModel, insProgress: InsInspectionActivityStatusEnum) {
        return (
            <>

import { InsFabricInspectionRequestCategoryEnum, InsInspectionRollSelectionTypeEnum, InsIrRollIdsRequest, InsLotNumberInspectionCategoryRequest, PackingListInfoModel, RollSelectionTypeEnum } from "@xpparel/shared-models";
...
export const RollSelectionForReRequest = (props: IRollSelectionForReRequestProps) => {
    ...
    const getRollInfoForLotAndInspectionType = (lotNumber: string, inspectionType: InsFabricInspectionRequestCategoryEnum) => {
        ...
        const reqObj = new InsLotNumberInspectionCategoryRequest(null, unitCode, companyCode, null, lotNumber, inspectionType);

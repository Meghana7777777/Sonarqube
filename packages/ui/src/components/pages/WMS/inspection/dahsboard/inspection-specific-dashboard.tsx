...
import { CodesRequest, CodesResponse, CommonRequestAttrs, InsFabricInspectionRequestCategoryEnum, InsInspectionActivityStatusEnum, ItemStylesRequest, PoNumbersItemCodeRequest } from "@xpparel/shared-models";
...
import { InspectionColumnarCard } from "./inspection-columnar-card";
import { InspectionDashboardHelper } from "./inspection-dashboard-helper";
...
export const InspectionSpecificDashboard = (props: InspectionSpecificDashboardProps) => {
    ...
    //for fetching Lots for selected styles

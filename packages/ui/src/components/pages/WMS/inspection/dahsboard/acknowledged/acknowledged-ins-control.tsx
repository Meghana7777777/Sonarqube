...
export const AcknowledgedInsControl = (props: AcknowledgedInsControlPorps) => {
    ...
    // -------------------------------- APIS START-------------------------------
    function confirmStartInspection(req: InsInspectionBasicInfoModel, date: string, remarks: string) {
    ...
    function renderInspectionStartConfirmationModal(req: InsInspectionBasicInfoModel) {

...
export const PalletRollAllocation = () => {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <Form.Item name="measuredWidth"  noStyle rules={[{ required: false }]}>
                                                            <InputNumber value={scannedRollInfo.rollInfo.measuredWidth} readOnly disabled style={{ width: "100%" }} />
                                                        </Form.Item></td>
                                                    <td>
                                                        <Form.Item name="measuredWeight" noStyle rules={[{ required: false }]}>
                                                            <InputNumber value={scannedRollInfo.rollInfo.measuredWeight} readOnly disabled style={{ width: "100%" }} />
                                                        </Form.Item></td>
                                                </tr>
                                            </tbody>
                                        </table>

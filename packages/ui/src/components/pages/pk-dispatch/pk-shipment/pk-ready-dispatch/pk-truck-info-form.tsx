...
import { Modal, Button, Row, Col, Form, Input, DatePicker, TimePicker, message, Table, Select } from 'antd';
...
const PkTruckInfoForm = ({ isVisible, onClose, initialFields, shippingRequestData, user, requestId }: IProps) => {
      ...
      <Row gutter={16}>
        <Col span={8} >
          <Form form={form} layout="vertical">
            <Row gutter={16} align="middle" style={{marginBottom: '50px'}}>
              <Col>
                <label>Auto Fill Truck Info: </label>
              </Col>
              <Col>
...
export default PkTruckInfoForm;

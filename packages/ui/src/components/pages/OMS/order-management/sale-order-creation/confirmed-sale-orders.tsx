...
const ConfirmedSaleOrdersPage = () => {
    ...
    const fetchConfirmedOrders = () => {
        ...
        saleOrderCreationService.getConfirmedSaleOrdersInfo(reqObj).then(res => {
            if (res.status) {
    ...
    return (
        <Card size='small' title="Confirmed Orders" style={{ marginTop: '10px' }}>
            <Table
                size='small'
                columns={columns}
...
export default ConfirmedSaleOrdersPage;

...
import { IComponentEmb, IProcessDetails, ISavedProcessData, ITblBasicData, ITblData, OperationRoutingTableProps, OperationRow } from './op-routing-interface';
import { AlertMessages } from '../../../common';
import ComponentEmbMapping from './component-emb-mapping';
...
const OperationRoutingTableForCut: React.FC<OperationRoutingTableProps> = ({ onSave, onConfirmSequence, savedTableData, processIndex, previousTableData, componentsData, processType, updateKey }) => {
                    ...
                    render: (_: any, record: ITblData) => {
                        ...
                        return (
                            <Select
                                mode="multiple"
                                style={{ width: '100%' }}
                                value={record.selectedComponents || undefined}
...
export default OperationRoutingTableForCut;

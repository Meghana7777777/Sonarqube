...
import { YarnTypeEnum, InsInspectionActivityStatusEnum, YarnInspectionBasicInfoModel, InsIrActivityChangeRequest } from "@xpparel/shared-models";
...
export const AcknowledgedInsControl = (props: AcknowledgedInsControlPorps) => {
    ...
    // -------------------------------- APIS START-------------------------------
    function confirmStartInspection(req: YarnInspectionBasicInfoModel, date: string, remarks: string) {
    ...
    function renderInspectionStartConfirmationModal(req: YarnInspectionBasicInfoModel) {

...
import { InsInspectionActivityStatusEnum, InsIrActivityChangeRequest, YarnInspectionBasicInfoModel, YarnTypeEnum } from "@xpparel/shared-models";
import { FabricInspectionCreationService, YarnInspectionCreationService } from "@xpparel/shared-services";
...
const yarnInspectionCreationService=new YarnInspectionCreationService();
export const PendingInsControl = (props: PendingInsControlProps) => {
    ...
    const [inspectionBasicInfo, setInspectionBasicInfo] = useState<YarnInspectionBasicInfoModel>();


    // -------------------------------- APIS START-------------------------------
    function confirmMaterialReceivedForInspection(req: YarnInspectionBasicInfoModel, date: string, remarks: string) {
        ...
        yarnInspectionCreationService.updateYarnInspectionActivityStatus(irConfReq).then(res => {
            if (res.status) {
    ...
    function renderInspectionMaterialConfirmationModal(req: YarnInspectionBasicInfoModel) {
    ...
    function reRequestConfirmingModel(req: YarnInspectionBasicInfoModel) {
    ...
    function renderModalBasedOnSelection(currentModalDefaultConfigs: CurrentModalOptions, req: YarnInspectionBasicInfoModel, insType: YarnTypeEnum) {
    ...
    function renderIrItemsInfoModal(req: YarnInspectionBasicInfoModel, insType: YarnTypeEnum) {

import { YarnTypeEnum, InsIrRollIdsRequest, InsLotNumberInspectionCategoryRequest, PackingListInfoModel, RollSelectionTypeEnum, YarnInsLotNumberInspectionCategoryRequest, InsInspectionRollSelectionTypeEnum } from "@xpparel/shared-models";
...
export const RollSelectionForReRequest = (props: IRollSelectionForReRequestProps) => {
    ...
    const getRollInfoForLotAndInspectionType = (lotNumber: string, inspectionType: YarnTypeEnum) => {

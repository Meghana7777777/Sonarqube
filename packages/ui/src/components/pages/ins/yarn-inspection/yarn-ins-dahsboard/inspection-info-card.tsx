import { YarnTypeEnum, InsInspectionActivityStatusEnum, YarnInspectionBasicInfoModel, InsInspectionFinalInSpectionStatusEnum } from "@xpparel/shared-models";
...
interface InspectionInfoCardProps {
    inspectionRollsInfo: YarnInspectionBasicInfoModel;
...
export const InspectionInfoCard = (props: InspectionInfoCardProps) => {
    ...
    // color = "radial-gradient(972.6px at 10% 20%, rgb(255, 105, 180) 0%, rgb(200, 160, 255) 90%)";

    // renders the buttons for the card
    function renderIrCardButtons(req: YarnInspectionBasicInfoModel, insType: YarnTypeEnum, insProgress: InsInspectionActivityStatusEnum) {
    ...
    function renderCardTitle(reqInfo: YarnInspectionBasicInfoModel) {
    ...
    function renderCardDescription(reqInfo: YarnInspectionBasicInfoModel) {
        return <>
    ...
    function renderHoverContent(rollsInfo: YarnInspectionBasicInfoModel, insProgress: InsInspectionActivityStatusEnum) {
        return (
            <>

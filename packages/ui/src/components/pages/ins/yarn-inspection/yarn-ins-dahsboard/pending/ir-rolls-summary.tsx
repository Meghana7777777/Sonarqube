import { YarnTypeEnum, InsInspectionActivityStatusEnum, YarnInspectionBasicInfoModel, InsIrIdRequest, InsIrRollsModel, YarnInsIrRollsModel, InsFabricInspectionRequestCategoryEnumDisplayValue, YarnTypeEnumDisplayValue } from "@xpparel/shared-models";
...
export const IrRollsSummary = (props: IrRollsSummaryProps) => {
    ...
    const [irRollsInfo, setIrRollsInfo] = useState<YarnInsIrRollsModel>();
    ...
    const getIrRolls = (req: YarnInspectionBasicInfoModel) => {
        ...
        yarnInspectionInfoService.getInspectionRequestSpollsInfo(irIdReq, true).then(res => {
            if (res.status) {
    ...
    function getTableData(data: YarnInsIrRollsModel) {
        const tableData = [];
    ...
    return (
        <>
            ...
            <Row>
                <Col span={5}>
                    <><b>Inspection type </b> : {YarnTypeEnumDisplayValue[props.typeOfInspection]}</>
                </Col>
                <Col span={5}>

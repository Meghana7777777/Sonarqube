...
import { InsInspectionActivityStatusEnum, InsInspectionFinalInSpectionStatusEnum, YarnInspectionBasicInfoModel, YarnTypeEnum } from "@xpparel/shared-models";
...
import InspectionTable from "../../yarn-inspection-forms/yarn-inspection/yarn-insp";
...
export const ClosedInsControl = (props: ClosedInsControlPorps) => {
    ...
    function renderInspectionStatusModal(req: YarnInspectionBasicInfoModel) {
    ...
    function renderModalBasedOnSelection(currentModalDefaultConfigs: CurrentModalOptions, req: YarnInspectionBasicInfoModel, insType: YarnTypeEnum, inspStats: InsInspectionActivityStatusEnum) {
    ...
    // todo:
    function renderIrItemsInfoModal(req: YarnInspectionBasicInfoModel, insType: YarnTypeEnum, inspStats: InsInspectionActivityStatusEnum) {
        let contentComponent = <></>;
        console.log('instypeee', insType);
        console.log('inspStats', inspStats);
        if (inspStats === InsInspectionActivityStatusEnum.COMPLETED) {
            // switch (insType) {
            //     case YarnTypeEnum.YARNINS:
    ...
    function renderPendingInsButtons(req: YarnInspectionBasicInfoModel, insType: YarnTypeEnum): any[] {
        ...
        // if(insType == YarnTypeEnum.INSPECTION) {
    ...
    return (
        <>
            ...
            {props.typeOfInspection === YarnTypeEnum.YARNINS && isModalOpen ? (
                <Modal
                    title={
                        <span
            ...
            {/* {props.typeOfInspection === YarnTypeEnum.YARNINS && labInspModelOpen ? (
                <Modal
                    title={
                        <span
                            style={{ textAlign: "center", display: "block", margin: "5px 0px" }}
            ...
            {props.typeOfInspection === YarnTypeEnum.SHADE_SEGREGATION && shadeSaggregationModelOpen ? (
                <Modal
                    title={
                        <span
                            style={{ textAlign: "center", display: "block", margin: "5px 0px" }}
            ...
            {props.typeOfInspection === YarnTypeEnum.RELAXATION && relaxationInspModel ? (
                <Modal
                    title={
                        <span
                            style={{ textAlign: "center", display: "block", margin: "5px 0px" }}
            ...
            {props.typeOfInspection === YarnTypeEnum.SHRINKAGE && shrinkageModelOpen ? (
                <Modal
                    title={
                        <span
                            style={{ textAlign: "center", display: "block", margin: "5px 0px" }}

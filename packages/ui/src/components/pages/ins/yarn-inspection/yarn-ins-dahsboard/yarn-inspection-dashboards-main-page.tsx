...
import { YarnTypeEnum, PackingListSummaryModel } from "@xpparel/shared-models";
...
export const YarnInspectionDashboardsMainPage = () => {
    ...
    const renderComponents = (step: number) => {
        switch (step) {
            case 0: return <InspectionSpecificDashboard key={"basic-inspection-dashboard"} typeOfInspection={YarnTypeEnum.YARNINS} />
...
export default YarnInspectionDashboardsMainPage;

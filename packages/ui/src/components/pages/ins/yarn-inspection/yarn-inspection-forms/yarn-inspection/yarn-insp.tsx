...
import { InsBasicInspectionRequest, InsConeBarcodeInspCategoryReq, InsFabricInspectionRequestCategoryEnum, InsFabricInspectionRequestCategoryEnumDisplayValue, InsInspectionFinalInSpectionStatusEnum, InsIrIdRequest, InsRollBarcodeInspCategoryReq, YarnInsBasicInspectionRequest, YarnTypeEnum, YarnTypeEnumDisplayValue } from '@xpparel/shared-models';
    ...
    return (
        <div id="fourPointInspectionId">
            <ScxCard
                ...
                <Descriptions bordered title='Yarn point inspection '>
                ...
                <Badge.Ribbon text={<span style={{ textAlign: "left" }}>Inspection request id:{fourPointInspectionDetails?.inspectionHeader?.inspectionReqId}</span>} color="red"  >
                    <ScxCard size='small' title={<div style={{ display: "flex", flexDirection: "row", justifyContent: "space-evenly", width: "100%" }}><span style={{ width: "10%" }}>Header Info</span><span style={{ width: "10%" }}>Inspection type :<b>{YarnTypeEnumDisplayValue[fourPointInspectionDetails?.inspectionHeader?.inspRequestCategory]}</b></span><Progress style={{ width: "10%" }} percent={inspCompPercentage} status="active" /></div>}>
                        <Descriptions size='small' bordered column={{ xxl: 4, xl: 3, lg: 3, md: 2, sm: 2, xs: 1 }}>
                            ...
                            <Descriptions.Item label={<b>{'Total Batch Rolls'}</b>} className='inspection-info1-no'><span style={{ color: "black" }}>{fourPointInspectionDetails?.inspectionHeader?.totalNoOfBatchRolls}</span></Descriptions.Item>

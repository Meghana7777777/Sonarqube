...
import { ThreadInspectionCreationService } from "@xpparel/shared-services";
...
export const AcknowledgedInsControl = (props: AcknowledgedInsControlPorps) => {
    ...
    // -------------------------------- APIS START-------------------------------
    function confirmStartInspection(req: ThreadInspectionBasicInfoModel, date: string, remarks: string) {
    ...
    function renderInspectionStartConfirmationModal(req: ThreadInspectionBasicInfoModel) {

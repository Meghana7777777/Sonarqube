...
import { InsInspectionActivityStatusEnum, ThreadInspectionBasicInfoModel, ThreadTypeEnum } from "@xpparel/shared-models";
import { Form, Modal } from "antd";
import { useAppSelector } from "packages/ui/src/common";
import { useState } from "react";
import FourPointInspectionForm from "../../thread-inspection-forms/thread-inspection/thread-inspection-form";
...
export const InProgressInsControl = (props: InProgressInsControlPorps) => {
    ...
    function getInspectionForm(irId: number, inspectionType: ThreadTypeEnum) {
    ...
    function renderInspectionUpdateModal(req: ThreadInspectionBasicInfoModel) {
        // setShowModal(true)
    ...
    return (
        <>
            ...
            <Modal title='Thread Inspection Update' width={'100vw'} style={{ top: 0, padding: 0 }} open={showModal} footer={null} onCancel={() => {
                setShowModal(false);
                // props.reloadDashboard();
            }}>
                {getInspectionForm(props.irInfo.irId, props.typeOfInspection)}

...
interface InspectionInfoCardProps {
    inspectionRollsInfo: ThreadInspectionBasicInfoModel;
...
export const InspectionInfoCard = (props: InspectionInfoCardProps) => {
   ...
   if (searchData && props.color) {
    ...
    function renderIrCardButtons(req: ThreadInspectionBasicInfoModel, insType: ThreadTypeEnum, insProgress: InsInspectionActivityStatusEnum) {
    ...
    function renderCardTitle(reqInfo: ThreadInspectionBasicInfoModel) {
    ...
    function renderCardDescription(reqInfo: ThreadInspectionBasicInfoModel) {
        return <>
    ...
    function renderHoverContent(rollsInfo: ThreadInspectionBasicInfoModel, insProgress: InsInspectionActivityStatusEnum) {
        return (
            <>

import { InsInspectionActivityStatusEnum, InsIrIdRequest, ThreadInsIrRollsModel, ThreadInspectionBasicInfoModel, ThreadTypeEnum, ThreadTypeEnumDisplayValue } from "@xpparel/shared-models";
...
export const IrRollsSummary = (props: IrRollsSummaryProps) => {
    ...
    const [irRollsInfo, setIrRollsInfo] = useState<ThreadInsIrRollsModel>();
    ...
    const getIrRolls = (req: ThreadInspectionBasicInfoModel) => {
        ...
        threadInspectionInfoService.getInspectionRequestSpollsInfo(irIdReq, true).then(res => {
            if (res.status) {
    ...
    function getTableData(data: ThreadInsIrRollsModel) {
        const tableData = [];
    ...
    return (
        <>
            ...
            <Row>
                <Col span={5}>
                    <><b>Inspection type </b> : {ThreadTypeEnumDisplayValue[props.typeOfInspection]}</>
                </Col>
                <Col span={5}>

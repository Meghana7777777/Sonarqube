...
import { CodesRequest, CommonRequestAttrs, InsInspectionActivityStatusEnum, ItemStylesRequest, PoNumbersItemCodeRequest, ThreadTypeEnum } from "@xpparel/shared-models";
...
const getStyleData = () => {
   ...
   const handleSelectChange = async (itemStyle: string) => {
    ...
    //for fetching batchcodes for selected itemcode

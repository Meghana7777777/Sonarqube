...
import { InsInspectionActivityStatusEnum, InsIrActivityChangeRequest, ThreadInspectionBasicInfoModel, ThreadTypeEnum } from "@xpparel/shared-models";
import { FabricInspectionCreationService, ThreadInspectionCreationService } from "@xpparel/shared-services";
...
const threadInspectionCreationService=new ThreadInspectionCreationService();
export const PendingInsControl = (props: PendingInsControlProps) => {
    ...
    const [inspectionBasicInfo, setInspectionBasicInfo] = useState<ThreadInspectionBasicInfoModel>();


    // -------------------------------- APIS START-------------------------------
    function confirmMaterialReceivedForInspection(req: ThreadInspectionBasicInfoModel, date: string, remarks: string) {
        ...
        threadInspectionCreationService.updateThreadInspectionActivityStatus(irConfReq).then(res => {
            if (res.status) {
    ...
    function renderInspectionMaterialConfirmationModal(req: ThreadInspectionBasicInfoModel) {
    ...
    function reRequestConfirmingModel(req: ThreadInspectionBasicInfoModel) {
    ...
    function renderModalBasedOnSelection(currentModalDefaultConfigs: CurrentModalOptions, req: ThreadInspectionBasicInfoModel, insType: ThreadTypeEnum) {
    ...
    function renderIrItemsInfoModal(req: ThreadInspectionBasicInfoModel, insType: ThreadTypeEnum) {

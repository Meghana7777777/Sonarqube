...
import { TrimTypeEnum, PackingListSummaryModel } from "@xpparel/shared-models";
import { Badge, Card, Steps } from "antd";
import { useEffect, useState } from "react";
import { useAppSelector, useCallbackPrompt } from "../../../../../common";
import { InspectionSpecificDashboard } from "./trim-inspection-specific-dashboard";


export const TrimInspectionDashboardsMainPage = () => {
    ...
    const renderComponents = (step: number) => {
        switch (step) {
            case 0: return <InspectionSpecificDashboard key={"basic-inspection-dashboard"} typeOfInspection={TrimTypeEnum.TRIMINS} />
...
export default TrimInspectionDashboardsMainPage;

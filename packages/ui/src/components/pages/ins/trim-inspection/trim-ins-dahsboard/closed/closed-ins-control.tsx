...
import { InsInspectionActivityStatusEnum, InsInspectionFinalInSpectionStatusEnum, TrimInspectionBasicInfoModel, TrimTypeEnum } from "@xpparel/shared-models";
...
import InspectionTable from "../../trim-inspection-forms/trim-inspection/trim-insp";
...
export const ClosedInsControl = (props: ClosedInsControlPorps) => {
    ...
    function renderInspectionStatusModal(req: TrimInspectionBasicInfoModel) {
    ...
    function renderModalBasedOnSelection(currentModalDefaultConfigs: CurrentModalOptions, req: TrimInspectionBasicInfoModel, insType: TrimTypeEnum, inspStats: InsInspectionActivityStatusEnum) {
    ...
    // todo:
    function renderIrItemsInfoModal(req: TrimInspectionBasicInfoModel, insType: TrimTypeEnum, inspStats: InsInspectionActivityStatusEnum) {
        let contentComponent = <></>;
        console.log('instypeee', insType);
        console.log('inspStats', inspStats);
        if (inspStats === InsInspectionActivityStatusEnum.COMPLETED) {
            // switch (insType) {
            //     case TrimTypeEnum.TRIMINS:
            //         console.log("Trim Inspection", req);
    ...
    return (
        <>
            ...
            {props.typeOfInspection === TrimTypeEnum.TRIMINS && isModalOpen ? (
                <Modal
                    title={
                        <span
            ...
            {/* {props.typeOfInspection === TrimTypeEnum.TRIMINS && labInspModelOpen ? (
                <Modal
                    title={
                        <span
                            style={{ textAlign: "center", display: "block", margin: "5px 0px" }}
            ...
            {props.typeOfInspection === TrimTypeEnum.SHADE_SEGREGATION && shadeSaggregationModelOpen ? (
                <Modal
                    title={
                        <span
                            style={{ textAlign: "center", display: "block", margin: "5px 0px" }}
            ...
            {props.typeOfInspection === TrimTypeEnum.RELAXATION && relaxationInspModel ? (
                <Modal
                    title={
                        <span
                            style={{ textAlign: "center", display: "block", margin: "5px 0px" }}
            ...
            {props.typeOfInspection === TrimTypeEnum.SHRINKAGE && shrinkageModelOpen ? (
                <Modal
                    title={
                        <span
                            style={{ textAlign: "center", display: "block", margin: "5px 0px" }}

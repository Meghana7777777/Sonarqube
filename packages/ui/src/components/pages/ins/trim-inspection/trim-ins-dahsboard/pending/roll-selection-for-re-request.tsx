import { InsInspectionRollSelectionTypeEnum, InsIrRollIdsRequest, PackingListInfoModel, RollSelectionTypeEnum, TrimInsLotNumberInspectionCategoryRequest, TrimTypeEnum, YarnInsLotNumberInspectionCategoryRequest } from "@xpparel/shared-models";
...
export const RollSelectionForReRequest = (props: IRollSelectionForReRequestProps) => {
    ...
    const getRollInfoForLotAndInspectionType = (lotNumber: string, inspectionType: TrimTypeEnum) => {
        ...
        const reqObj = new TrimInsLotNumberInspectionCategoryRequest(null, unitCode, companyCode, null, lotNumber, inspectionType);

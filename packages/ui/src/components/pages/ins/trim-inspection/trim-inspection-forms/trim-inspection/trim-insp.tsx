...
import { InsBasicInspectionRequest, InsFabricInspectionRequestCategoryEnum, InsInspectionFinalInSpectionStatusEnum, InsIrIdRequest, InsRollBarcodeInspCategoryReq, TrimInsBasicInspectionRequest } from '@xpparel/shared-models';
    ...
    return (
        <div id="fourPointInspectionId">
            <ScxCard
                ...
                <Descriptions bordered title='Trim inspection '>

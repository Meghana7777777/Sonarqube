...
export default function FGWAFgOutTab({statusUpdate}:Props) {
    ...
    return (
        <>
            <FGWAReqHeaderTable approvalStatus={PkmsFgWhReqApprovalEnum.APPROVED} reqType={PkmsFgWhReqTypeEnum.OUT} currentStage={[PkmsFgWhCurrStageEnum.LOC_UNMAP_COMPLETED,PkmsFgWhCurrStageEnum.FG_OUT_PROGRESS]} actionColumns={actionColumns} />
            <Modal
